...
export const galeriaItems = [
  // ── Casamentos ──
  { src: imgItaloTiago,       label: 'Italo & Tiago',              cat: 'casamento' },
  { src: imgStephanieMatheus, label: 'Stephanie & Matheus',        cat: 'casamento' },
  ...
  { src: imgLuanaAndre,       label: 'Luana & André',              cat: 'casamento' },
  { src: imgMarianaGabriel,   label: 'Mariana & Gabriel',          cat: 'casamento' },
  { src: imgMichellePedro,    label: 'Michelle & Pedro Alexandre',  cat: 'casamento' },
  { src: imgYasminCaio,       label: 'Yasmin & Caio',              cat: 'casamento' },
  { src: imgThainaBruno,      label: 'Thainá & Bruno',             cat: 'casamento' },
  { src: imgIreneGabriel,     label: 'Irene & Gabriel',            cat: 'casamento' },
  { src: imgLeticiaJunior,    label: 'Letícia & Júnior',           cat: 'casamento' },
  { src: imgCatarinaCarlos,   label: 'Catarina & Carlos',          cat: 'casamento' },
  { src: imgMarcelaAndre,     label: 'Marcela & André',            cat: 'casamento' },
  // ── Debutantes ──
  ...
  { src: imgJuliaDelfina,     label: 'Júlia Delfina',              cat: 'debutante' },
  { src: imgMarianaHorta,     label: 'Mariana Horta',              cat: 'debutante' },
  { src: imgMaluPalmeira,     label: 'Malu Palmeira',              cat: 'debutante' },
  { src: imgDudaMaynard,      label: 'Duda Maynard',               cat: 'debutante' },
  { src: imgSophiaMatheus,    label: 'Sophia Matheus',             cat: 'debutante' },
  { src: imgBrunaLenzi,       label: 'Bruna Lenzi',                cat: 'debutante' },
  { src: imgPaolaRezende,     label: 'Paola Rezende',              cat: 'debutante' },
  { src: imgNataliaMenezes,   label: 'Natália Menezes',            cat: 'debutante' },
  // ── Eventos ──
  { src: imgJaneVieira,       label: 'Jane Vieira',                cat: 'evento'    },
